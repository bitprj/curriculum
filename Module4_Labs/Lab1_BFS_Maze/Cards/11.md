...
def readMazeFromFile(f):
      ...
      return maze
 ```
Breaking this down, we start by constructing a list type object with the name maze. This will be where we store the contents of the maze file. For the purposes of this lab, this list is essentially an array and we will refer to it as such from here on.
...
Thus, by looking at how the maze file is read, we know that any maze is represented as a 2D array of characters.
