...
Overall, when implementing a hash table, you want to create the hash function that can hash the values in your list most efficiently and avoid elements hashed to the same index. Elements which are hashed to the same index are considered **collisions**, which we will discuss in the next section. 
